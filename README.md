...
Removed non-informative identifier columns from the dataset

Performed Exploratory Data Analysis (EDA) to compare voice features between Healthy individuals and Parkinson’s patients

Analyzed key biomedical voice features such as Jitter, Shimmer, and Fundamental frequency measures

Scaled numerical features using StandardScaler to ensure equal feature contribution

Applied feature selection techniques to reduce redundancy and improve generalization

Used Stratified Train-Test Split to preserve class distribution

Trained a Support Vector Machine (SVM) classification model
